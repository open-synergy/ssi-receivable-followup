...
class ReceivableFollowUpDetail(models.Model):
    ...
    date_invoice = fields.Date(
        string="Date", related="invoice_id.date", store=True
    )
    ...
    def _compute_amount(self):
        for record in self:
            ...
            criteria = [
                ...
                ("credit_move_id.date", ">=", fields.Date.to_string(record.follow_up_id.date_start)),
                ("credit_move_id.date", "<=", fields.Date.to_string(record.follow_up_id.date_end)),
            ]
